...
Jupyter Notebook Link for **Price Point Analyis** is [Price Point Analysis](https://examples.com "Jupyter notebook").
...
Jupyter Notebook Link for **Price Point Analyis** is [Area/Region Analysis](https://nbviewer.jupyter.org/github/halotx3/ccass-wine-ds/blob/master/geocode_slc/Wine_Geocode.ipynb "Jupyter notebook").
...
Jupyter Notebook Link for **Price Point Analyis** is [Climate Analysis](https://nbviewer.jupyter.org/github/halotx3/ccass-wine-ds/blob/master/APH/WinoAPH_Climate.ipynb "Jupyter notebook").

> ##### Average annual temperature by province (2006 ~ 2015)

![Temparature by Province](./img/ah/fig_APH01.png)

> ##### Average annual precipitation by province (2006 ~ 2015)
