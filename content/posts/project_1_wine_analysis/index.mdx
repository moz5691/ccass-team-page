...
Jupyter Notebook Link for **Description and Points Analyis** is [HERE](https://nbviewer.jupyter.org/github/halotx3/ccass-wine-ds/blob/ca-baseline/wine-ca.ipynb "Jupyter notebook").
